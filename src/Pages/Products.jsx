...
//          <lottie-player src="https://assets7.lottiefiles.com/datafiles/AX0rqrGV5ahKpWr/data.json"  background="transparent"  speed="1"  style={{width: "100%", height: "500px"}}  loop  autoplay></lottie-player>
//         </div>
//       }
//       {error && 
//         <div style={{height: "45rem", marginTop: "50px"}}>
//          <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_rz0hyab1.json"  background="transparent"  speed="1"  style={{width: "100%", height: "500px"}}  loop autoplay></lottie-player>
//         </div>
//       }
//       {!loading && !error &&
...
//                       <Radio size="lg" value="DETTOL" onChange={(e)=>handleCompany(e.target.value)}></Radio>
//                     </Flex>
//                     <Flex w="100%" justify="space-between">
//                       <Text w="90%">Revital</Text>
//                       <Radio size="lg" value="REVITAL" onChange={(e)=>handleCompany(e.target.value)}></Radio>
//                     </Flex>
//                     <Flex w="100%" justify="space-between">
//                       <Text w="90%">Pharmeasy</Text>
//                       <Radio size="lg" value="PHARMEASY" onChange={(e)=>handleCompany(e.target.value)}></Radio>
//                     </Flex>
//                     <Flex w="100%" justify="space-between">
//                       <Text w="90%">Everherb</Text>
//                       <Radio size="lg" value="EVERHERB" onChange={(e)=>handleCompany(e.target.value)}></Radio>
//                     </Flex>
//                     <Flex w="100%" justify="space-between">
//                       <Text w="90%">Liveasy</Text>
//                       <Radio size="lg" value="LIVEASY" onChange={(e)=>handleCompany(e.target.value)}></Radio>
//                     </Flex>
//                     <Text cursor="pointer" color="#0f847e" fontWeight="700">
//                       View More
//                     </Text>
...
//                     Sort Price {menu}
//                   </MenuButton>
//                   <MenuList w="15rem" boxShadow="rgba(0, 0, 0, 0.09) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.01) 5px 20px 16px">
//                     <MenuItem
//                       fontWeight={menu === "Price Low to High" ? "700" : "400"}
//                       color={menu === "Price Low to High" ? "#0f847e" : "black"}
...
//                     </MenuItem>
//                     <MenuItem
//                       fontWeight={menu === "Price High to Low" ? "700" : "400"}
//                       color={menu === "Price High to Low" ? "#0f847e" : "black"}
