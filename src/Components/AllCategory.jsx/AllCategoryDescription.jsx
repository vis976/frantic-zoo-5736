...
import "../Styles/AllCategoryDescription.css"
const AllCatagoryDescription = () => {
  return (
    <div >
      <div className="descriptionDiv" style={{textAlign: "left"}}>
        <div >
          <h3 className="catagoryHeading">Shop Safely And Worry-Free On PharmEasy</h3>
          <p className="catagoryTexts">
        ...
        <div className="listDiv">
          <h3 className="catagoryHeading">Why choose PharmEasy?</h3>
          <p className="catagoryTexts">
            <ul>
              <li>8400+ Brands</li>
        ...
        <div >
          <h3 className="catagoryHeading">Our most popular categories:</h3>
          <p className="catagoryTexts">
            We have a range of categories and products, some which are:
          </p>
        </div>
        <div >
          <h3 className="catagoryHeading">Devices</h3>
          <p className="catagoryTexts">
        ...
        <div >
          <h3 className="catagoryHeading">Personal care</h3>
          <p className="catagoryTexts">
        ...
        <div >
          <h3 className="catagoryHeading">Nutrition and fitness supplements</h3>
          <p className="catagoryTexts">
        ...
        <div >
          <h3 className="catagoryHeading">Ayurvedic care</h3>
          <p className="catagoryTexts">
        ...
        <div >
          <h3 className="catagoryHeading">Home care</h3>
          <p className="catagoryTexts">
        ...
        <div className="catagoryTexts9">
          <h3 className="catagoryHeading">Baby and mom care</h3>
          <p className="catagoryTexts">
        ...
        <div >
          <h3 className="catagoryHeading">Our top brands:</h3>
          <p className="catagoryTexts">
        ...
        <div >
          <h3 className="catagoryHeading">You are safe with PharmEasy:</h3>
          <p className="catagoryTexts">
        ...
        <div className="listDiv" >
          <h3 className="catagoryHeading">We ensure</h3>
          <p className="catagoryTexts">
            <ul>
        ...
        <div >
          <h3 className="catagoryHeading">Youe safety is our priority</h3>
          <p className="catagoryTexts">
...
export default AllCatagoryDescription;
